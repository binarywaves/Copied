...
CategoryModel._set_binding_type(type.StructType(
    'com.vmware.cis.tagging.category_model', {
        ...
        'cardinality': type.ReferenceType(sys.modules[__name__], 'CategoryModel.Cardinality'),
...
class Category(VapiInterface):
    ...
    UpdateSpec._set_binding_type(type.StructType(
        'com.vmware.cis.tagging.category.update_spec', {
            ...
            'cardinality': type.OptionalType(type.ReferenceType(sys.modules[__name__], 'CategoryModel.Cardinality')),
...
class _CategoryStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_input_type = type.StructType('operation-input', {
            'create_spec': type.ReferenceType(sys.modules[__name__], 'Category.CreateSpec'),
        })
        create_error_dict = {
        ...
        update_input_type = type.StructType('operation-input', {
            'category_id': type.IdType(resource_types='com.vmware.cis.tagging.Category'),
            'update_spec': type.ReferenceType(sys.modules[__name__], 'Category.UpdateSpec'),
        })
        update_error_dict = {
            'com.vmware.vapi.std.errors.already_exists':
                type.ReferenceType(com.vmware.vapi.std.errors_client, 'AlreadyExists'),
        ...
        add_to_used_by_input_validator_list = [
        ]
        ...
        remove_from_used_by_input_validator_list = [
        ]
        ...
        revoke_propagating_permissions_input_validator_list = [
        ]
        ...
        operations = {
            ...
            'get': {
                ...
                'output_type': type.ReferenceType(sys.modules[__name__], 'CategoryModel'),
        ...
        ApiInterfaceStub.__init__(self, iface_name='com.vmware.cis.tagging.category',
                                  config=config,
...
class _TagStub(ApiInterfaceStub):
    def __init__(self, config):
        # properties for create operation
        create_input_type = type.StructType('operation-input', {
            'create_spec': type.ReferenceType(sys.modules[__name__], 'Tag.CreateSpec'),
        })
        create_error_dict = {
            'com.vmware.vapi.std.errors.already_exists':
                type.ReferenceType(com.vmware.vapi.std.errors_client, 'AlreadyExists'),
        ...
        update_input_type = type.StructType('operation-input', {
            'tag_id': type.IdType(resource_types='com.vmware.cis.tagging.Tag'),
            'update_spec': type.ReferenceType(sys.modules[__name__], 'Tag.UpdateSpec'),
        })
        update_error_dict = {
            'com.vmware.vapi.std.errors.already_exists':
                type.ReferenceType(com.vmware.vapi.std.errors_client, 'AlreadyExists'),
        ...
        list_used_tags_input_validator_list = [
        ]
        ...
        list_tags_for_category_input_validator_list = [
        ]
        ...
        operations = {
            ...
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType(sys.modules[__name__], 'TagModel'),
                'errors': get_error_dict,
                'input_validator_list': get_input_validator_list,
                'output_validator_list': get_output_validator_list,
            },
        ...
        ApiInterfaceStub.__init__(self, iface_name='com.vmware.cis.tagging.tag',
                                  config=config,
                                  operations=operations)
class _TagAssociationStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        attach_multiple_tags_to_object_input_validator_list = [
        ]
        ...
        attach_tag_to_multiple_objects_input_validator_list = [
        ]
        ...
        detach_multiple_tags_from_object_input_validator_list = [
        ]
        ...
        detach_tag_from_multiple_objects_input_validator_list = [
        ]
        ...
        list_attached_objects_input_validator_list = [
        ]
        ...
        list_attached_objects_on_tags_input_validator_list = [
        ]
        ...
        list_attached_tags_input_validator_list = [
        ]
        ...
        list_attached_tags_on_objects_input_validator_list = [
        ]
        ...
        list_attachable_tags_input_validator_list = [
        ]
        ...
        operations = {
            ...
            'attach_multiple_tags_to_object': {
                ...
                'output_type': type.ReferenceType(sys.modules[__name__], 'TagAssociation.BatchResult'),
            ...
            'list_attached_objects_on_tags': {
                ...
                'output_type': type.ListType(type.ReferenceType(sys.modules[__name__], 'TagAssociation.TagToObjects')),
            ...
            'list_attached_tags_on_objects': {
                ...
                'output_type': type.ListType(type.ReferenceType(sys.modules[__name__], 'TagAssociation.ObjectToTags')),
