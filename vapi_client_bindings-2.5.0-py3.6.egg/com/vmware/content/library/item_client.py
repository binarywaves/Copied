...
DownloadSessionModel._set_binding_type(type.StructType(
    'com.vmware.content.library.item.download_session_model', {
        ...
        'state': type.OptionalType(type.ReferenceType(sys.modules[__name__], 'DownloadSessionModel.State')),
...
UpdateSessionModel._set_binding_type(type.StructType(
    'com.vmware.content.library.item.update_session_model', {
        ...
        'error_message': type.OptionalType(type.ReferenceType(com.vmware.vapi.std_client, 'LocalizableMessage')),
        'client_progress': type.OptionalType(type.IntegerType()),
        'state': type.OptionalType(type.ReferenceType(sys.modules[__name__], 'UpdateSessionModel.State')),
        'expiration_time': type.OptionalType(type.DateTimeType()),
    },
    UpdateSessionModel,
    True,
...
class File(VapiInterface):
    ...
    ChecksumInfo._set_binding_type(type.StructType(
        'com.vmware.content.library.item.file.checksum_info', {
            'algorithm': type.OptionalType(type.ReferenceType(sys.modules[__name__], 'File.ChecksumAlgorithm')),
    ...
    Info._set_binding_type(type.StructType(
        'com.vmware.content.library.item.file.info', {
            'checksum_info': type.OptionalType(type.ReferenceType(sys.modules[__name__], 'File.ChecksumInfo')),
...
class Storage(VapiInterface):
    ...
    class Info(VapiStruct):
        ...
        def __init__(self,
            ...
            :param storage_backing: The storage backing on which this object resides.
...
class UpdateSession(VapiInterface):
    ...
    def cancel(self,
        ...
        """
        Cancels the update session and deletes it. This method will free up any
...
class _DownloadSessionStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_input_type = type.StructType('operation-input', {
            ...
            'create_spec': type.ReferenceType(sys.modules[__name__], 'DownloadSessionModel'),
        })
        create_error_dict = {
        ...
        keep_alive_input_validator_list = [
        ]
        ...
        operations = {
            ...
            'get': {
                ...
                'output_type': type.ReferenceType(sys.modules[__name__], 'DownloadSessionModel'),
        ...
        ApiInterfaceStub.__init__(self, iface_name='com.vmware.content.library.item.download_session',
                                  config=config,
...
class _FileStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType(sys.modules[__name__], 'File.Info'),
                'errors': get_error_dict,
                'input_validator_list': get_input_validator_list,
                'output_validator_list': get_output_validator_list,
            },
            'list': {
                'input_type': list_input_type,
                'output_type': type.ListType(type.ReferenceType(sys.modules[__name__], 'File.Info')),
                'errors': list_error_dict,
                'input_validator_list': list_input_validator_list,
                'output_validator_list': list_output_validator_list,
            },
        }
        ApiInterfaceStub.__init__(self, iface_name='com.vmware.content.library.item.file',
                                  config=config,
                                  operations=operations)
class _StorageStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        operations = {
            'get': {
                'input_type': get_input_type,
                'output_type': type.ListType(type.ReferenceType(sys.modules[__name__], 'Storage.Info')),
                'errors': get_error_dict,
                'input_validator_list': get_input_validator_list,
                'output_validator_list': get_output_validator_list,
            },
        ...
        ApiInterfaceStub.__init__(self, iface_name='com.vmware.content.library.item.storage',
                                  config=config,
                                  operations=operations)
class _UpdateSessionStub(ApiInterfaceStub):
    def __init__(self, config):
        ...
        create_input_type = type.StructType('operation-input', {
            'client_token': type.OptionalType(type.StringType()),
            'create_spec': type.ReferenceType(sys.modules[__name__], 'UpdateSessionModel'),
        })
        create_error_dict = {
            'com.vmware.vapi.std.errors.invalid_argument':
                type.ReferenceType(com.vmware.vapi.std.errors_client, 'InvalidArgument'),
        ...
        operations = {
            ...
            'get': {
                'input_type': get_input_type,
                'output_type': type.ReferenceType(sys.modules[__name__], 'UpdateSessionModel'),
                'errors': get_error_dict,
                'input_validator_list': get_input_validator_list,
                'output_validator_list': get_output_validator_list,
            },
        ...
        ApiInterfaceStub.__init__(self, iface_name='com.vmware.content.library.item.update_session',
                                  config=config,
                                  operations=operations)
